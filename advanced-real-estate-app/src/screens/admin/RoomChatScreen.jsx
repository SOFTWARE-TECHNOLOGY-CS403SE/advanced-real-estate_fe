...
const RoomChatScreen = () => {
    ...
    const refresh = async () =>{
        return await handleApiRequest("/api/admin/room-chats", {}, "get", auth?.token)
    ...
    const handleUpload = async () => {
        ...
        try {
            await handleApiRequest(`/api/admin/room-chats/${editingRoomChat?.id}/upload-image`,
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                {editingRoomChat?.id === roomChat.id ? (
                                                    ...
                                                    <img src={`data:${roomChat?.file_type};base64,${roomChat?.image}`}
                                                         alt={roomChat?.file_type} width={"200px"}
                                                    />
                                                )}
                                            </td>
                                            <td>
